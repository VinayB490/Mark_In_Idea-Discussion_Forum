			 ...
			 <div class="collapse navbar-collapse" id="navbarSupportedContent">
			    <ul class="navbar-nav ml-auto mr-2">			      
			      <li class="nav-item mr-5">
			         <a class="nav-link" href="lqadis.php">Home<span class="sr-only"></span></a>
			      </li>
			      <li class="nav-item mr-5">
	    	...
	    	<div class="row  form-wrapper">
	    		...
	    		<div class="col-lg-10 col-sm-12 col-md-10 text-white form-container container">
	    			...
	    			<div class="text-center text-uppercase form-header page-header">	    				<br><br>
	    				<input type="text" name="blk" id="blk" placeholder="Enter tag or username or a keyword " class="form-control" required>
	    				<br>
